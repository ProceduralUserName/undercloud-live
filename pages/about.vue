...
<template>
  <LandingContainer>
    <!-- Hero Section -->
    <div class="pt-36 bg-gradient-to-r from-purple-600 to-orange-500 text-center py-12 text-white rounded-lg shadow-lg">
    ...
    <!-- Simon Section -->
    <div class="bg-black rounded-lg pb-16 mx-auto mt-8 py-8">
